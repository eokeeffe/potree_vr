...
Potree.FirstPersonControls = class GamePad extends THREE.EventDispatcher{
    ...
    function get_gamepad_map(id)
    {
        if(id==null||id===undefined){return;}

        if(id.lowercase().indexOf("phonejoy"))
        {
            var dict = {
              pad_id:id
              axes: 2,
        ...
        if(id.lowercase().indexOf("mocute"))
        {
            var dict = {
              up: 13,
              down: 14,
